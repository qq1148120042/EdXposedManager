...
import org.ks.tool.manager.receiver.PackageChangeReceiver;
import org.ks.tool.manager.util.ModuleUtil;
import org.ks.tool.manager.util.NotificationUtil;
...
import static org.ks.tool.manager.adapter.AppHelper.FORCE_WHITE_LIST_MODULE;

@SuppressLint("Registered")
public class XposedApp extends com.android.ks.tool.installer.XposedApp implements ActivityLifecycleCallbacks {
    ...
    public static InstallZipUtil.XposedProp getXposedProp() {
        return com.android.ks.tool.installer.XposedApp.getInstance().mXposedProp;
    }
...
//                drawable, color);
    ...
    public void onCreate() {
        ...
        com.android.ks.tool.installer.XposedApp.getInstance().reloadXposedProp();
        createDirectories();
